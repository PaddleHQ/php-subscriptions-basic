<?php
	...
	// the users ID. We retrieve this with each alert/ notification
	// using the 'passthrough' variable. In production, you should
	// add some checking to make sure this user exists.
	$user_id = $db->real_escape_string($_POST['passthrough']);
	
	// The unique ID of this users subscription.
	...
	// The status of this users subscription
	$status = $db->real_escape_string($_POST['status']);
	
	// Respond appropreately to this request.
	switch($alert_name) {
		case 'subscription_created':
			// The next billing date of this users subscription.
		...
		case 'subscription_payment_succeeded':
			...
			/*
				...
				neccecary, as you can access this information from the Paddle Dashboard.
		...
		case 'subscription_payment_failed':			
			/*
				Here, you might wish to eamil the customer telling them that you attempted
				to charge them for their subscription, however you were unable to.
